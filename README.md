# FHCI Job Finder using Next, Tailwind, and Typescript
...
- 💎 Pre-built Components — Components that will **automatically adapt** with your brand color, [check here for the demo](https://fhci-finder.vercel.app/components)
