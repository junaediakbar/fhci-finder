...
const defaultMeta = {
  title: 'Project | FHCI BUMN Finder',
  siteName: 'FHCI BUMN Finder ',
  description:
    'A website to find list of jobs and their requirements in FHCI BUMN 2024',
  /** Without additional '/' on the end, e.g. https://theodorusclarence.com */
  url: 'https://fhci-finder.vercel.app/',
  type: 'website',
  robots: 'follow, index',
  /**
   ...
   */
  image: 'https://fhci-finder.vercel.app/images/logo-large.png',
};
